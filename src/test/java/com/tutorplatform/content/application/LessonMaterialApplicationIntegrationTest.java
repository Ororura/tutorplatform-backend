...
class LessonMaterialApplicationIntegrationTest extends PostgresIntegrationTest {
    ...
    static void configurePostgres(DynamicPropertyRegistry registry) {
        PostgresIntegrationTest.configurePostgres(
                registry, "test_lesson_material_application", "008");
    }
    ...
    void teacherCreatesTextMaterial() {
        ...
        LessonMaterialResult created =
                createMaterial(fixture, LessonMaterialType.TEXT, "Текст", "Содержимое", null, 0);
    ...
    void updateChangesAllowedFieldsAndMaterialType() {
        ...
        LessonMaterialResult updated =
                lessonMaterialService.updateLessonMaterial(
                        fixture.principal(),
                        fixture.topic().id(),
                        created.id(),
    ...
    void typeChangeRejectsStalePayload() {
        ...
        assertThat(
                        lessonMaterialService
                                ...
                                .materialType())
                .isEqualTo(LessonMaterialType.TEXT);
    }
    ...
    private LessonMaterialResult createTextMaterial(
            ContentFixture fixture, String title, int position) {
        return createMaterial(
                fixture, LessonMaterialType.TEXT, title, "Содержимое", null, position);
    }
    ...
    private UpdateLessonMaterialCommand updateTextCommand(
            LessonMaterialResult source, String title) {
