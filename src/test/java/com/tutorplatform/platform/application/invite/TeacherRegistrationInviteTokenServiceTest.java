...
class TeacherRegistrationInviteTokenServiceTest {
    ...
    void generatesUrlSafeToken() {
        ...
        assertThat(token.rawValue()).matches("^[A-Za-z0-9_-]{43}$");
    }
    ...
    void generatesSha256Hash() {
        ...
        assertThat(token.hash()).isEqualTo(service.hash(token.rawValue()));
    }
    ...
    void neverUsesRawTokenAsHash() {
        ...
        assertThat(token.hash()).isNotEqualTo(token.rawValue());
    }
    ...
    void sameTokenAlwaysProducesSameHash() {
        ...
        assertThat(service.hash(rawToken)).isEqualTo(service.hash(rawToken));
    }
}
