...
public interface TeacherTaskApi {
    ...
    @Operation(operationId = "getTask", summary = "Get a task; CODE details include all teacher-visible tests")
    @ApiResponses({
    ...
    @Operation(operationId = "updateTask", summary = "Update common task fields and lifecycle status")
    @ApiResponses({
    ...
    @Operation(operationId = "updateProgrammingTaskConfig", summary = "Update CODE task configuration")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Configuration updated"),
        @ApiResponse(responseCode = "400", description = "Invalid configuration or task type", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "401", description = "Authentication required", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "403", description = "Teacher role required", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "404", description = "Task not found", content = @Content(schema = @Schema(implementation = ApiError.class)))
    })
    ...
    @Operation(operationId = "replaceTaskTestCases", summary = "Atomically replace CODE task test cases")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Test cases replaced"),
        @ApiResponse(responseCode = "400", description = "Invalid test cases or task type", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "401", description = "Authentication required", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "403", description = "Teacher role required", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "404", description = "Task not found", content = @Content(schema = @Schema(implementation = ApiError.class)))
    })
