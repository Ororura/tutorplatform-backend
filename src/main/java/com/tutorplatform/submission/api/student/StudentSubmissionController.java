...
public class StudentSubmissionController implements StudentSubmissionApi {
    ...
    public StudentSubmissionController(
            SubmissionService submissionService, CodeSubmissionService codeSubmissionService) {
    ...
    public ResponseEntity<StudentSubmissionResponse> submitTextAnswer(
        ...
        StudentSubmissionResponse response =
                StudentSubmissionResponse.from(
    ...
    private ResponseEntity<StudentSubmissionResponse> created(StudentSubmissionResponse response) {
        return ResponseEntity.created(URI.create("/api/v1/student/submissions/" + response.id()))
                .body(response);
    }
    ...
    public StudentSubmissionPageResponse listStudentTaskSubmissions(
        ...
        return StudentSubmissionPageResponse.from(
                submissionService.listStudentTaskSubmissions(
    ...
    public StudentSubmissionResponse getStudentSubmission(
            @AuthenticationPrincipal AuthenticatedUser principal, @PathVariable UUID submissionId) {
