...
public class JpaStudentTopicProgressRepository implements StudentTopicProgressRepository {
    ...
    public JpaStudentTopicProgressRepository(
            StudentTopicProgressDatabaseRepository databaseRepository) {
        this.databaseRepository = databaseRepository;
    }

    @Override
    public StudentTopicProgressEntity saveAndFlush(StudentTopicProgressEntity progress) {
        StudentTopicProgressId id =
                new StudentTopicProgressId(progress.studentProgramId(), progress.topicId());
        StudentTopicProgressDatabaseModel model =
                databaseRepository
                        .findById(id)
