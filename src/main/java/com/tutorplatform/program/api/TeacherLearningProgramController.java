...
public class TeacherLearningProgramController implements TeacherLearningProgramApi {
    ...
    public LearningProgramDetailsResponse getProgramBySlug(
            @AuthenticationPrincipal AuthenticatedUser principal, @PathVariable String slug) {
    ...
    public ResponseEntity<LearningProgramModuleResponse> createModule(
        ...
        LearningProgramModuleResponse response =
                service.createModule(principal, programId, request);
    ...
    @Override
    @PutMapping("/{programId}/modules/order")
    public ResponseEntity<Void> reorderModules(
            @AuthenticationPrincipal AuthenticatedUser principal,
            @PathVariable UUID programId,
            @Valid @RequestBody ReorderLearningProgramModulesRequest request) {
        service.reorderModules(principal, programId, request);
    ...
    public ResponseEntity<LearningProgramTopicDetailsResponse> createTopic(
        ...
        LearningProgramTopicDetailsResponse response =
                service.createTopic(principal, programId, moduleId, request);
        return ResponseEntity.created(
                        URI.create(
                                "/api/v1/teacher/programs/"
                                        + programId
