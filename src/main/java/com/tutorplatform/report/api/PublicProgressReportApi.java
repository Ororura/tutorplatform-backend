...
public interface PublicProgressReportApi {
    ...
    @Operation(
            operationId = "getPublicProgressReport",
            summary = "Get a historical progress report by share token")
    @ApiResponses({
    ...
    @Operation(
            operationId = "downloadPublicProgressReportPdf",
            summary = "Download a shared published progress report as PDF")
    @ApiResponses({
        @ApiResponse(
                responseCode = "200",
