...
public interface TeacherReportShareApi {
    ...
    @Operation(
            operationId = "createReportShare",
            summary = "Create a historical progress-report share")
    @ApiResponses({
    ...
    ResponseEntity<Void> revokeReportShare(
            @Parameter(hidden = true) AuthenticatedUser principal, UUID reportId, UUID shareId);
}
