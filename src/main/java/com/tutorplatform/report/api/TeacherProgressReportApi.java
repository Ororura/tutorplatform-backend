...
public interface TeacherProgressReportApi {
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "404", description = "Student program or learning period not found", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "409", description = "Report already exists or period is invalid", content = @Content(schema = @Schema(implementation = ApiError.class)))
    })
    ...
    @Operation(operationId = "listProgressReports", summary = "List progress reports accessible to the current teacher")
    @ApiResponses({
    ...
    ProgressReportPageResponse listProgressReports(
        ...
        @Parameter(description = "Allow-listed field,direction", example = "createdAt,desc") String sort
    );

    @Operation(operationId = "getProgressReport", summary = "Get a persisted progress report snapshot")
    @ApiResponses({
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "403", description = "Teacher role required", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "404", description = "Progress report not found", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "409", description = "Report is not editable or version is stale", content = @Content(schema = @Schema(implementation = ApiError.class)))
    })
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "403", description = "Teacher role required", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "404", description = "Progress report not found", content = @Content(schema = @Schema(implementation = ApiError.class))),
        @ApiResponse(responseCode = "409", description = "Report is not publishable or version is stale", content = @Content(schema = @Schema(implementation = ApiError.class)))
    })
