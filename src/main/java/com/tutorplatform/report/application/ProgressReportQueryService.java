...
public class ProgressReportQueryService {
    ...
    private static final Set<String> ALLOWED_SORT_FIELDS = Set.of(
        "createdAt", "updatedAt", "periodStartedAt", "periodEndedAt", "publishedAt", "status"
    );
    ...
    public ProgressReport get(AuthenticatedUser principal, UUID reportId) {
        ...
        return repository.findOwnedById(reportId, teacherId)
    ...
    public ProgressReport get(
        ...
        return repository.findOwnedById(reportId, studentProgramId, authorized.teacherId())
            .orElseThrow(ProgressReportNotFoundException::new);
    }
    ...
    public ProgressReportPageResult list(
        ...
        ProgressReportPage result = repository.listByStudentProgramId(
            studentProgramId, page, size
        );
    ...
    public ProgressReportSummaryPageResult list(
        ...
        UUID teacherId = authorization.currentTeacherId(principal);
        ProgressReportSummaryPage result = readQuery.findOwnedPage(
            teacherId, studentProgramId, status, page, size,
            parameters.field(), parameters.ascending()
        );
