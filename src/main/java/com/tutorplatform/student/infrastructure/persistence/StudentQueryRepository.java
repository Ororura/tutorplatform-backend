...
public class StudentQueryRepository {
    ...
    public StudentPage findStudents(
        ...
        long totalElements = statement("SELECT count(*) " + filters, teacherId, searchPattern, accountStatus)
                .query(Long.class)
                .single();

        List<StudentSummaryRow> items = statement(selectSql, teacherId, searchPattern, accountStatus)
    ...
    private JdbcClient.StatementSpec statement(
        ...
        return jdbcClient.sql(sql)
                ...
                .param("accountStatus", accountStatus == null ? null : accountStatus.name(), Types.VARCHAR);
    }
