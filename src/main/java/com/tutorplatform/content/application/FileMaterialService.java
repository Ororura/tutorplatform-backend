...
public class FileMaterialService {
    ...
    @Transactional
    public LessonMaterialResult upload(
        ...
        // ERROR with an opaque key for reconciliation. Process-crash atomicity needs an
    ...
    public record Download(
            LessonMaterialType materialType, String filename, String mimeType, byte[] content) {}
}
