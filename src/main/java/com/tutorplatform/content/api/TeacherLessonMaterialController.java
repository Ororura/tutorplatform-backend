...
public class TeacherLessonMaterialController implements TeacherLessonMaterialApi {
    ...
    public TeacherLessonMaterialController(
            LessonMaterialService lessonMaterialService, FileMaterialService fileMaterialService) {
    ...
    public ResponseEntity<LessonMaterialResponse> uploadLessonMaterial(
        ...
        try (var input = file.getInputStream()) {
            var created =
                    LessonMaterialResponse.from(
                            fileMaterialService.upload(
                                    principal,
                                    topicId,
                                    materialType,
                                    title,
    ...
    public ResponseEntity<LessonMaterialResponse> createLessonMaterial(
        ...
        LessonMaterialResponse created =
                LessonMaterialResponse.from(
