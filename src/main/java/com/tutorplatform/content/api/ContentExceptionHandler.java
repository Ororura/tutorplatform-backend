...
public class ContentExceptionHandler {
    ...
    ResponseEntity<ApiError> handleInvalidLessonMaterialOrder(
        ...
        return ResponseEntity.badRequest()
                .body(
                        ApiError.of(
                                "LESSON_MATERIAL_ORDER_INVALID",
                                "Lesson material order is invalid",
                                MDC.get("traceId")));
    }
    ...
    ResponseEntity<ApiError> handleLessonMaterialNotFound(
    ...
    ResponseEntity<ApiError> handleFileTooLarge(FileTooLargeException exception) {
        return ResponseEntity.status(HttpStatus.PAYLOAD_TOO_LARGE)
                .body(
                        ApiError.of(
                                "FILE_TOO_LARGE", "File exceeds upload limit", MDC.get("traceId")));
    }
}
