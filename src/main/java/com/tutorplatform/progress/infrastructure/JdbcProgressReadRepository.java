...
public class JdbcProgressReadRepository implements ProgressReadRepository {
    ...
    @Override
    public List<TopicProgress> findTopicProgress(UUID studentProgramId, ProgressInterval interval) {
        return jdbcClient
                .sql(
                        """
    ...
    public AssessmentAverages getAssessmentAverages(
            UUID studentProgramId, ProgressInterval interval) {
        return jdbcClient
                .sql(
                        """
                SELECT AVG(assessment.understanding_score) AS understanding_average,
    ...
    private static TopicProgress mapTopicProgress(ResultSet resultSet, int rowNumber)
            throws SQLException {
