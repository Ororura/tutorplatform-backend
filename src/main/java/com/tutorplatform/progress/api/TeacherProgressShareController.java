...
public class TeacherProgressShareController implements TeacherProgressShareApi {
    ...
    public ResponseEntity<ProgressShareCreatedResponse> createProgressShare(
        ...
        ProgressShareCreatedResponse response = progressShareService.create(principal, studentId, request);
        return ResponseEntity.created(URI.create(
            "/api/v1/teacher/students/" + studentId + "/progress/shares/" + response.id()
        )).body(response);
    }
