...
public class AdminPlatformSettingsController {
    ...
    public AdminPlatformSettingsController(PlatformSettingsService settingsService) {
        this.settingsService = settingsService;
    }

    @Operation(operationId = "getAdminPlatformSettings", summary = "Get platform settings")
    @GetMapping
    public PlatformSettingsResponse getSettings() {

        return PlatformSettingsResponse.from(settingsService.getSettings());
    }
    ...
    public PlatformSettingsResponse changeRegistrationMode(
        ...
        return PlatformSettingsResponse.from(
                settingsService.changeRegistrationMode(request.mode(), adminId));
    }
}
