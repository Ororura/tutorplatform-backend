...
public record LessonSessionSummaryResponse(
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, minimum = "1", maximum = "600") int durationMinutes,
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED) AttendanceStatus attendanceStatus,
    @Schema(nullable = true) String summary,
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED) List<LessonSessionTopicResponse> topics,
    ...
    public static LessonSessionSummaryResponse from(LessonSessionResult session) {
        return new LessonSessionSummaryResponse(
            session.id(),
