...
public class TeacherLessonSessionController implements TeacherLessonSessionApi {
    ...
    public LessonSessionPageResponse listLessonSessions(
        ...
        return LessonSessionPageResponse.from(
                lessonSessionService.listLessonSessions(principal, studentId, page, size, sort));
    }
    ...
    public LessonSessionDetailsResponse getLessonSession(
        ...
        return LessonSessionDetailsResponse.from(
                lessonSessionService.getLessonSession(principal, studentId, sessionId));
    }
