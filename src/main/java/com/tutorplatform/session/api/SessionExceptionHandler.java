...
public class SessionExceptionHandler {
    ...
    ResponseEntity<ApiError> handleInvalidSessionListParameter(
            InvalidSessionListParameterException exception) {
    ...
    ResponseEntity<ApiError> handleInvalidLessonSessionTopics(
            InvalidLessonSessionTopicsException exception) {
        return ResponseEntity.badRequest()
                .body(
                        ApiError.of(
                                "LESSON_SESSION_TOPICS_INVALID",
                                exception.getMessage(),
                                MDC.get("traceId")));
    }

    @ExceptionHandler(TopicOutsideStudentProgramException.class)
    ResponseEntity<ApiError> handleTopicOutsideStudentProgram(
            TopicOutsideStudentProgramException exception) {
        return ResponseEntity.badRequest()
                .body(
                        ApiError.of(
    ...
    ResponseEntity<ApiError> handleLessonSessionVersionConflict(
            LessonSessionVersionConflictException exception) {
