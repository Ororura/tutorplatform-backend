...
public class HomeworkExceptionHandler {
    ...
    ResponseEntity<ApiError> handleHomeworkNotFound(HomeworkNotFoundException exception) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(ApiError.of("HOMEWORK_NOT_FOUND", "Homework not found", MDC.get("traceId")));
    }

    @ExceptionHandler(HomeworkStudentProgramNotFoundException.class)
    ResponseEntity<ApiError> handleHomeworkStudentProgramNotFound(
            HomeworkStudentProgramNotFoundException exception) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(
                        ApiError.of(
    ...
    ResponseEntity<ApiError> handleHomeworkTaskSubjectMismatch(
            HomeworkTaskSubjectMismatchException exception) {
        return ResponseEntity.badRequest()
                .body(
                        ApiError.of(
    ...
    ResponseEntity<ApiError> handleHomeworkTaskNotAssignable(
            HomeworkTaskNotAssignableException exception) {
        return ResponseEntity.badRequest()
                .body(
                        ApiError.of(
    ...
    ResponseEntity<ApiError> handleHomeworkItemPositionConflict(
            HomeworkItemPositionConflictException exception) {
    ...
    ResponseEntity<ApiError> handleHomeworkVersionConflict(
            HomeworkVersionConflictException exception) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(
                        ApiError.of(
