...
public class TeacherHomeworkController implements TeacherHomeworkApi {
    ...
    public HomeworkPageResponse listHomeworks(
        ...
        return HomeworkPageResponse.from(
                homeworkService.listHomeworks(
    ...
    public HomeworkDetailsResponse getHomework(
        ...
        return HomeworkDetailsResponse.from(
                homeworkService.getHomework(principal, studentId, homeworkId));
    }
    ...
    public HomeworkDetailsResponse cancelHomework(
            ...
            @PathVariable UUID homeworkId) {
        return HomeworkDetailsResponse.from(
                homeworkService.cancelHomework(principal, studentId, homeworkId));
    }
