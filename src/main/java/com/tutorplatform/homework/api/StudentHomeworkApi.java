...
public interface StudentHomeworkApi {
    ...
    @Operation(
            operationId = "listStudentHomeworks",
            summary = "List homework assigned to the current student")
    @ApiResponses({
    ...
    StudentHomeworkPageResponse listStudentHomeworks(
            ...
            @Parameter(description = "Optional student program owned by the current student")
            ...
            @Parameter(description = "Sort as field,direction", example = "assignedAt,desc")
                    String sort);

    @Operation(
            operationId = "getStudentHomework",
            summary = "Get homework assigned to the current student")
    @ApiResponses({
